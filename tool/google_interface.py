...
#https://blog.csdn.net/MAX_Hope/article/details/114398844
...
# ---------------------------------------------------------
def get_picture(left, top, right, bottom, zoom, filePath, style='s', server="Google China"):
    """
...
if __name__ == '__main__':
    ...
    get_picture(100.361, 38.842, 100.364, 38.839, 20, r'./test.tif', server="Google")
